<form action="<?php echo base_url("native/record/index")?>" method="post">
        <div class="main">
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="text-align:center;">
                          <div class="modal-footer">
                            <a type='button' href="<?php echo base_url("native/record/record_list")?>" class="btn btn-lg pull-left btn-default"><i class="fas fa-glasses"></i> 기록보기</a>
                          <?php
                          if($recordinfo->id > 0){
                          ?>
                              ...
                              <!-- //<a href="<?php echo base_url("native/record/popup_confirm")?>/<?=$recordinfo->id?>" class="btn btn-default"  data-toggle="modal" data-target="#exampleModal">>삭제</a> -->
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="<?php echo base_url("native/record/delete")?>/<?=$recordinfo->id?>" class="btn btn-primary">삭제</a>
