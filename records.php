    ...
    <body>
                ...
                <div id="inputs">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-xs-5">
                	        	<input type="text" id="eatMl" value="200" class="form-control"/>
                        </div>
                        <div class="col-md-1 col-xs-2">
                            <button type="button" class="glyphicon glyphicon-arrow-up btn-round btn-info" id="upQuantity">10</button>
                        </div>
                        <div class="col-md-1 col-xs-2">
                            <button type="button" class="glyphicon glyphicon-arrow-down btn-round btn-info" id="downQuantity">10</button>
                        </div>
                    </div>
                  </div>
                </div>
      ...
      <script type="text/javascript">
        ...
        $('#upQuantity').on('click', function () {
           $("#eatMl").val() = Integer.parseInt($("#eatMl").val()) + 10;
        })
        $('#downQuantity').on('click', function () {
           $("#eatMl").val() = $("#eatMl").val() - 10;
        })
    </script>
</html>
